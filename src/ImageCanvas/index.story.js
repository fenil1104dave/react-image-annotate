...
storiesOf('ImageCanvas', module)
	.add('Basic', () => <ImageCanvas regions={testRegions} imageSrc={exampleImage} showTags {...events} />)
	.add('Zoom Tool Selected', () => (
		<ImageCanvas showTags regions={testRegions} imageSrc={exampleImage} zoomWithPrimary {...events} />
	))
	.add('Allowed Area', () => (
		<ImageCanvas
			showTags
